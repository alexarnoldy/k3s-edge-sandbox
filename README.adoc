...
NOTE: server_vcpu and server_memory should be specified on the first server only. As well, agent_vcpu and agent_memory should be specified on the first agent only.
